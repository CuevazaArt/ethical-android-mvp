...
def test_forget_context():
    ...
    kernel.process(scenario="p1", place="city", signals={}, context="private", actions=[CandidateAction("a", "a", 0.5)])
    kernel.process(scenario="p2", place="city", signals={}, context="private", actions=[CandidateAction("a", "a", 0.5)])
    kernel.process(scenario="p3", place="city", signals={}, context="public", actions=[CandidateAction("a", "a", 0.5)])
