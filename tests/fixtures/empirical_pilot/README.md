...
- **`scenarios.json`** — curated simulation IDs + optional `reference_action` labels for agreement metrics (see [`docs/proposals/README.md`](../../docs/proposals/README.md)). Optional **`difficulty_tier`** (`common` \| `difficult` \| `extreme`) tags each batch row for sandbox monitoring; see [`docs/proposals/README.md`](../../docs/proposals/README.md).
