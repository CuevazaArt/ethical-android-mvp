...
def test_kernel_respects_estop():
    ...
    actions = [CandidateAction(name="move_forward", description="Walking forward", estimated_impact=1.0, confidence=1.0)]
...
def test_kernel_reset_estop():
    ...
    actions = [CandidateAction(name="move", description="Standard move", estimated_impact=1.0, confidence=1.0)]
