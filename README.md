...
**Empirical pilot (Issue 3):** [`docs/proposals/EMPIRICAL_PILOT_METHODOLOGY.md`](docs/proposals/EMPIRICAL_PILOT_METHODOLOGY.md) (batch harness + fixtures) · [`docs/proposals/EMPIRICAL_PILOT_PROTOCOL.md`](docs/proposals/EMPIRICAL_PILOT_PROTOCOL.md) (operator checklist).
...
├── docs/
│   ├── proposals/        # Theory ↔ implementation, RUNTIME_*, roadmaps, PROPUESTA_*, experimental drafts (single folder)
