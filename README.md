...
| Perception / sensors / vitality | `KERNEL_SENSOR_*`, `KERNEL_MULTIMODAL_*`, `KERNEL_VITALITY_*` | [Flag families](docs/proposals/KERNEL_ENV_POLICY.md#1-flag-families-mental-model) |
