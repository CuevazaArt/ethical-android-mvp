...
class ZeroconfAdvertiser:
    ...
    def start(self):
        try:
            ...
            _log.warning("Zeroconf: Library NOT found. Task 14.1 inactive. Run 'pip install zeroconf' to enable mDNS.")
...
_ADVERTISER: Optional[ZeroconfAdvertiser] = None

def start_zeroconf_broadcast(port: int, name: Optional[str] = None):
    global _ADVERTISER
