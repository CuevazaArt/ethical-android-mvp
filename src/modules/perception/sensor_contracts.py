...
def merge_nomad_vision_into_snapshot(snapshot: SensorSnapshot | None) -> SensorSnapshot | None:
    ...
    from src.modules.perception.vision_adapter import get_nomad_vision_consumer_optional
    from src.modules.perception.vision_signal_mapper import VisionSignalMapper
