...
_FAMILY_RULES: Final[tuple[tuple[str, tuple[str, ...]], ...]] = (
    ...
    ("Perception / sensors", ("KERNEL_SENSOR_", "KERNEL_MULTIMODAL_", "KERNEL_VITALITY_", "KERNEL_PERCEPTION_", "KERNEL_LIGHT_RISK_", "KERNEL_CROSS_CHECK_", "KERNEL_CHAT_INCLUDE_LIGHT_RISK")),
    ("MalAbs lexical", ("KERNEL_MALABS_",)),
    ("MalAbs semantic / embed", ("KERNEL_SEMANTIC_",)),
    ("Governance / hub / judicial", ("KERNEL_MORAL_HUB_", "KERNEL_DEONTIC_", "KERNEL_JUDICIAL_", "KERNEL_DAO_", "KERNEL_LOCAL_SOVEREIGNTY")),
    ...
    ("LLM / variability / generative", ("KERNEL_VARIABILITY", "KERNEL_GENERATIVE_", "KERNEL_VERBAL_", "LLM_MODE")),
...
def build_operator_config_report() -> dict[str, Any]:
    ...
    return {
        ...
        "by_family": {k: [{"key": a, "value": b} for a, b in v] for k, v in sorted(by_family.items())},
