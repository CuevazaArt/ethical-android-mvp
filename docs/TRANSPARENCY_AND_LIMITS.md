...
Details: [INPUT_TRUST_THREAT_MODEL.md](proposals/INPUT_TRUST_THREAT_MODEL.md), [MALABS_SEMANTIC_LAYERS.md](proposals/MALABS_SEMANTIC_LAYERS.md), [KERNEL_ENV_POLICY.md](proposals/KERNEL_ENV_POLICY.md).
