...
| **Tiered experimental sandbox (common / difficult / extreme) + pilot `by_tier`** | [PROPOSAL_EXPERIMENTAL_SANDBOX_SCENARIOS.md](PROPOSAL_EXPERIMENTAL_SANDBOX_SCENARIOS.md) |
