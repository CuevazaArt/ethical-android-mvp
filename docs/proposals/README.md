...
| **LAN governance — merge conflicts / replay sidecar / cross-session / frontier witnesses** | [PROPOSAL_LAN_GOVERNANCE_CONFLICT_TAXONOMY.md](PROPOSAL_LAN_GOVERNANCE_CONFLICT_TAXONOMY.md) · [PROPOSAL_LAN_GOVERNANCE_REPLAY_SIDECAR.md](PROPOSAL_LAN_GOVERNANCE_REPLAY_SIDECAR.md) · [PROPOSAL_LAN_GOVERNANCE_CROSS_SESSION_HINT.md](PROPOSAL_LAN_GOVERNANCE_CROSS_SESSION_HINT.md) · [PROPOSAL_LAN_GOVERNANCE_FRONTIER_WITNESS.md](PROPOSAL_LAN_GOVERNANCE_FRONTIER_WITNESS.md) |
