...
**Simulation limits (no chain, QV assumptions, not the policy core):** [MOCK_DAO_SIMULATION_LIMITS.md](MOCK_DAO_SIMULATION_LIMITS.md) · **Solidity stub only:** [`contracts/README.md`](../../contracts/README.md).
