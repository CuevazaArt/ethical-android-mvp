...
- **Shipped engineering priors** for the default constants are **`0.82`** (θ_block) and **`0.45`** (θ_allow), matching `DEFAULT_SEMANTIC_SIM_BLOCK_THRESHOLD` / `DEFAULT_SEMANTIC_SIM_ALLOW_THRESHOLD` in code.
