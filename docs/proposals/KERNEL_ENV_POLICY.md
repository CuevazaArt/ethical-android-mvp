...
| **Fleet stub (lab)** | `KERNEL_FLEET_STUB` | Enables optional use of fleet peer stub digest helpers in tooling — **no** P2P stack, **no** kernel change. (`KERNEL_SWARM_STUB` was the legacy name, retired V2.159.) |
