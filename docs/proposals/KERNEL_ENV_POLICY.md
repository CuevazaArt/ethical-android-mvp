...
|--------|-------------------|------|
| **Chat JSON telemetry** | `KERNEL_CHAT_INCLUDE_*` (incl. **`KERNEL_CHAT_INCLUDE_TRANSPARENCY_S10`** — optional `transparency_s10`), `KERNEL_CHAT_EXPOSE_MONOLOGUE` | Omit or include **UX fields** in WebSocket payloads — **no** ethical veto. |
