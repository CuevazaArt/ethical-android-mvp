...
| **Guardian Angel** | `KERNEL_GUARDIAN_MODE`, `KERNEL_GUARDIAN_ROUTINES`, `KERNEL_GUARDIAN_ROUTINES_PATH`, `KERNEL_CHAT_INCLUDE_GUARDIAN`, `KERNEL_CHAT_INCLUDE_GUARDIAN_ROUTINES` | Protective tone + optional JSON care routines (hints only). |
