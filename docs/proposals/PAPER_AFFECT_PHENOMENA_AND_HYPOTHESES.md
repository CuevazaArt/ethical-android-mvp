...
- [BIBLIOGRAPHY.md on `main-whit-landing`](https://github.com/CuevazaArt/ethical-android-mvp/blob/main-whit-landing/BIBLIOGRAPHY.md) — academic literature (add PAD / circumplex when cited in formal work).
