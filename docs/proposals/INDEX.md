...
- [CORE_DECISION_CHAIN.md](CORE_DECISION_CHAIN.md) — Mechanics of the ethical decision pipeline.
- [PAPER_AFFECT_PHENOMENA_AND_HYPOTHESES.md](PAPER_AFFECT_PHENOMENA_AND_HYPOTHESES.md) — Affective modeling and PAD state theory.
- [TEMPORAL_PRIOR_HORIZONS.md](TEMPORAL_PRIOR_HORIZONS.md) — Subjective time and experiential priors.
- [UNIVERSAL_ETHOS_AND_HUB.md](UNIVERSAL_ETHOS_AND_HUB.md) — Cross-agent ethical alignment.

## 🛡️ Safety & Governance
- [INPUT_TRUST_THREAT_MODEL.md](INPUT_TRUST_THREAT_MODEL.md) — Threat model for user inputs and MalAbs.
- [MALABS_SEMANTIC_LAYERS.md](MALABS_SEMANTIC_LAYERS.md) — Implementation of semantic lexical gates.
- [KERNEL_ENV_POLICY.md](KERNEL_ENV_POLICY.md) — Security policy for environment variables.
- [MOCK_DAO_SIMULATION_LIMITS.md](MOCK_DAO_SIMULATION_LIMITS.md) — Limits and behavior of the simulated DAO.
- [SWARM_P2P_THREAT_MODEL.md](SWARM_P2P_THREAT_MODEL.md) — Security for decentralized agent collaboration.

## 🧪 Evaluation & Methodology
- [EMPIRICAL_METHODOLOGY.md](EMPIRICAL_METHODOLOGY.md) — How we measure ethical performance.
...
- [OBSERVABILITY_DASHBOARD_GUIDE.md](OBSERVABILITY_DASHBOARD_GUIDE.md) — Using the real-time visual dashboard.
- [GLOSSARY_PROMPTS_AND_COMMANDS.md](GLOSSARY_PROMPTS_AND_COMMANDS.md) — Technical terminology and CLI usage.
- [GUIDE_WIKI_SYNC_SETUP.md](GUIDE_WIKI_SYNC_SETUP.md) — Documentation synchronization guide.

## 📱 Integration & Runtime
- [RUNTIME_CONTRACT.md](RUNTIME_CONTRACT.md) — The API/process contract for the kernel.
- [RUNTIME_PHASES.md](RUNTIME_PHASES.md) — Boot and lifecycle phases.
- [LOCAL_PC_AND_MOBILE_LAN.md](LOCAL_PC_AND_MOBILE_LAN.md) — Nomad bridge and LAN networking.
- [PROTOCOL_NOMAD_FIELD_TEST.md](PROTOCOL_NOMAD_FIELD_TEST.md) — Field testing protocols for mobile devices.
