...
- **2026-04-17:** Canonical copy under `docs/proposals/`; **`GET /health`** documents **`nomad_bridge`** (`nomad_bridge_queue_stats_v3`) + Nomad singleton note in Summary; LAN/justice cross-links via `docs/archive_v1-7/proposals/` (not duplicated under `docs/proposals/`).
