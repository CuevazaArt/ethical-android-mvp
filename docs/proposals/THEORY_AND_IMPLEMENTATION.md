...
| **Fleet stub (v9.3 lab)** | Huellas deterministas de veredicto / stats descriptivos; sin red ni veto | Retired stub (removed V2.159); canonical: `src/core/fleet_telemetry.py` |
