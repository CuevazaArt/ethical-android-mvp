...
**Traceability and bibliography (recent implementations):** component ↔ support table with numbered refs in [TRACE_IMPLEMENTATION_RECENT.md](TRACE_IMPLEMENTATION_RECENT.md) and the expanded index in [`BIBLIOGRAPHY.md`](../../BIBLIOGRAPHY.md) (*Index by project component*).
