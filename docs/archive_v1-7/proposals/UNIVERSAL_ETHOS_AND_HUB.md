...
| **NomadIdentity** | Hardware jump + continuity of self | `nomad_identity.py` (facade) + `ImmortalityProtocol` + checkpoint; HAL: [PROPOSAL_NOMAD_CONSCIOUSNESS_HAL.md](PROPOSAL_NOMAD_CONSCIOUSNESS_HAL.md), `hardware_abstraction.py`, `existential_serialization.py` |
