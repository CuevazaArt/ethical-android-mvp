...
1. **Document first:** [`CORE_DECISION_CHAIN.md`](../proposals/CORE_DECISION_CHAIN.md) is the canonical map; [`pyproject.toml`](../../pyproject.toml) carries **stub** project metadata and optional dependency groups — **not** a claim of a published wheel on PyPI yet.
