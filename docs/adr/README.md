...
| [0018 — presentation tier vs ethical core](0018-presentation-tier-vs-ethical-core.md) | MER: separate conversational UX (prefetch, transparency S10, basal smoothing, prompt hints) from MalAbs and `KernelDecision` defaults (**Proposed**) |
