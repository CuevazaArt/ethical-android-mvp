...
### Cursor Team Updates
- **Governance hygiene (L1-SUPREMACY-01):** Deleted `.cursor/rules/02-autonomous-git.mdc` (unauthorized L2-authored duplicate). [`AGENTS.md`](AGENTS.md) reserves edits under `.cursor/rules/` to **Antigravity** (L1). Canonical hub workflow and PR expectations: [`.cursor/rules/collaboration-prioritization.mdc`](.cursor/rules/collaboration-prioritization.mdc) and [`docs/collaboration/MULTI_OFFICE_GIT_WORKFLOW.md`](docs/collaboration/MULTI_OFFICE_GIT_WORKFLOW.md); continuous audit before integration per [`.cursor/rules/l1-supremacy-and-audit.mdc`](.cursor/rules/l1-supremacy-and-audit.mdc); optional fast-push traceability in [`.cursor/rules/agile-collaboration-and-promotion.mdc`](.cursor/rules/agile-collaboration-and-promotion.mdc).
