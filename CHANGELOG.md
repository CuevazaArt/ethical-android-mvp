...
- **Semantic MalAbs Thresholds:** Added `scripts/evaluate_semantic_thresholds.py` for initial empirical evaluation of θ_block / θ_allow on a labeled dataset. Updated [`PROPOSAL_MALABS_SEMANTIC_THRESHOLD_EVIDENCE.md`](docs/proposals/PROPOSAL_MALABS_SEMANTIC_THRESHOLD_EVIDENCE.md) with evaluation methodology and trade-off analysis.
