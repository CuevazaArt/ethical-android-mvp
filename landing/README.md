...
**Version sync:** After changing `../pyproject.toml` or this package’s `version`, run `npm run sync-kernel-meta` and commit `src/config/kernelRepo.json`. CI enforces zero drift.
